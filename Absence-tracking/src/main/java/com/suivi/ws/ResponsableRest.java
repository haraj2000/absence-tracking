...
public class ResponsableRest {
	...
	@PostMapping("/{libelle}")
	public int save(@RequestBody ResponsableFilière responsableFilière, @PathVariable String libelle) {
		return responsableFilièreService.save(responsableFilière,libelle);
	}
	@PostMapping("/update")
